...
| --- | --- | --- | --- |
| `ui/app.slint` colors, game picker, Klondike/Spider/FreeCell layouts, focus treatment, and card back | Solitaire contributors | MIT | Authored as geometric Slint primitives for this repository on 2026-08-20; no external visual reference was traced. |
