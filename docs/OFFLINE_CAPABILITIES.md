...
| `quality.accessibility` | Keyboard and assistive-technology acceptance | Partial | Real Wayland keyboard navigation/activation, visible focus, AT-SPI names/actions/states across all five games, and changing live-region names were observed at exact SHA f6b0cb7e55d296bdf77714efc48a1775b858c041. A dedicated full-width character-wrapped, vertically scrollable, display-only live-region surface for long recovery and conflict status is now implemented at 1180x820, with recovery actions retained in their keyboard order; exact-package visual and AT-SPI acceptance of the new surface, full keyboard-only traversal, and Orca spoken output remain pending. |
| `quality.real-omarchy` | Real Omarchy and Wayland acceptance | Partial | At exact SHA f6b0cb7e55d296bdf77714efc48a1775b858c041, installed legal mutation/save/reopen in all five games, plugin summon, shell responsiveness, native-process survival across shell restart, quarantine, conflict recovery, and clean shutdown were observed on real Omarchy/Wayland. A dedicated wrapped and vertically scrollable long-status surface is implemented but awaits exact-package visual and AT-SPI acceptance; Orca, complete-deal UI wins, drag/touch, and live missing-binary/startup-failure notifications remain pending. |
