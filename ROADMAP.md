...
- Standard-mode TriPeaks is playable through the original Slint layout, with a pinned normal complete-deal candidate and controller lifecycle proof. Its installed final transition, optional wild-card work, touch/platform acceptance, and broader evidence remain open.
- Standard Pyramid is playable through an original seven-row Slint layout, with a pinned normal complete-deal candidate and controller lifecycle proof. Its installed final transition, solvability metadata, optional rule variants, touch/platform acceptance, and broader evidence remain open.
